...
$title_5 = get_field('title_5');
$title_6 = get_field('title_6');
$site_url_1 = get_field('site_url_1');
$site_url_2 = get_field('site_url_2');
$site_url_3 = get_field('site_url_3');
$site_url_4 = get_field('site_url_4');
$site_url_5 = get_field('site_url_5');
$site_url_6 = get_field('site_url_6');
$tw_1 = get_field('tw_1');
$tw_2 = get_field('tw_2');
$tw_3 = get_field('tw_3');
$tw_4 = get_field('tw_4');
...
<div class="social-box">
  ...
  <div class="card sc-1 view overlay hm-stylish-strong" style="width: 20rem;" >
    ...
    <div class="mask">
      ...
      <a href="https://www.facebook.com/sharer.php?u=<?php echo $fb_1; ?>" class="fb-a" target="_blank">
        <svg class="share-fb" id="Layer_1" style="enable-background:new 0 0 24 24;" version="1.1" viewBox="0 0 24 24" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><g><path  fill="#ffffff" d="M21.5,24.003h-5c-0.276,0-0.5-0.224-0.5-0.5v-9c0-0.276,0.224-0.5,0.5-0.5h2.64l0.667-2H16.5c-0.276,0-0.5-0.224-0.5-0.5   v-3c0-1.378,1.122-2.5,2.5-2.5H20v-2h-1.5c-2.481,0-4.5,2.019-4.5,4.5v3c0,0.276-0.224,0.5-0.5,0.5H11v2h2.5   c0.276,0,0.5,0.224,0.5,0.5v9c0,0.276-0.224,0.5-0.5,0.5h-11c-1.378,0-2.5-1.122-2.5-2.5v-19c0-1.378,1.122-2.5,2.5-2.5h19   c1.378,0,2.5,1.122,2.5,2.5v19C24,22.881,22.878,24.003,21.5,24.003z M17,23.003h4.5c0.827,0,1.5-0.673,1.5-1.5v-19   c0-0.827-0.673-1.5-1.5-1.5h-19c-0.827,0-1.5,0.673-1.5,1.5v19c0,0.827,0.673,1.5,1.5,1.5H13v-8h-2.5c-0.276,0-0.5-0.224-0.5-0.5   v-3c0-0.276,0.224-0.5,0.5-0.5H13v-2.5c0-3.033,2.467-5.5,5.5-5.5h2c0.276,0,0.5,0.224,0.5,0.5v3c0,0.276-0.224,0.5-0.5,0.5h-2   c-0.827,0-1.5,0.673-1.5,1.5v2.5h3.5c0.161,0,0.312,0.077,0.406,0.208c0.094,0.13,0.12,0.298,0.068,0.451l-1,3   c-0.068,0.204-0.259,0.342-0.474,0.342H17V23.003z"/></g><g/><g/><g/><g/><g/><g/><g/><g/><g/><g/><g/><g/><g/><g/><g/></svg></a>


      <a href="https://www.instagram.com/karialbrocoaching/" class="in-a" target="_blank"><svg class="share-in" aria-labelledby="simpleicons-instagram-icon" fill="#ffffff" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><title id="simpleicons-instagram-icon">Instagram icon</title><path d="M12 0C8.74 0 8.333.015 7.053.072 5.775.132 4.905.333 4.14.63c-.789.306-1.459.717-2.126 1.384S.935 3.35.63 4.14C.333 4.905.131 5.775.072 7.053.012 8.333 0 8.74 0 12s.015 3.667.072 4.947c.06 1.277.261 2.148.558 2.913.306.788.717 1.459 1.384 2.126.667.666 1.336 1.079 2.126 1.384.766.296 1.636.499 2.913.558C8.333 23.988 8.74 24 12 24s3.667-.015 4.947-.072c1.277-.06 2.148-.262 2.913-.558.788-.306 1.459-.718 2.126-1.384.666-.667 1.079-1.335 1.384-2.126.296-.765.499-1.636.558-2.913.06-1.28.072-1.687.072-4.947s-.015-3.667-.072-4.947c-.06-1.277-.262-2.149-.558-2.913-.306-.789-.718-1.459-1.384-2.126C21.319 1.347 20.651.935 19.86.63c-.765-.297-1.636-.499-2.913-.558C15.667.012 15.26 0 12 0zm0 2.16c3.203 0 3.585.016 4.85.071 1.17.055 1.805.249 2.227.415.562.217.96.477 1.382.896.419.42.679.819.896 1.381.164.422.36 1.057.413 2.227.057 1.266.07 1.646.07 4.85s-.015 3.585-.074 4.85c-.061 1.17-.256 1.805-.421 2.227-.224.562-.479.96-.899 1.382-.419.419-.824.679-1.38.896-.42.164-1.065.36-2.235.413-1.274.057-1.649.07-4.859.07-3.211 0-3.586-.015-4.859-.074-1.171-.061-1.816-.256-2.236-.421-.569-.224-.96-.479-1.379-.899-.421-.419-.69-.824-.9-1.38-.165-.42-.359-1.065-.42-2.235-.045-1.26-.061-1.649-.061-4.844 0-3.196.016-3.586.061-4.861.061-1.17.255-1.814.42-2.234.21-.57.479-.96.9-1.381.419-.419.81-.689 1.379-.898.42-.166 1.051-.361 2.221-.421 1.275-.045 1.65-.06 4.859-.06l.045.03zm0 3.678c-3.405 0-6.162 2.76-6.162 6.162 0 3.405 2.76 6.162 6.162 6.162 3.405 0 6.162-2.76 6.162-6.162 0-3.405-2.76-6.162-6.162-6.162zM12 16c-2.21 0-4-1.79-4-4s1.79-4 4-4 4 1.79 4 4-1.79 4-4 4zm7.846-10.405c0 .795-.646 1.44-1.44 1.44-.795 0-1.44-.646-1.44-1.44 0-.794.646-1.439 1.44-1.439.793-.001 1.44.645 1.44 1.439z"/></svg></a>

      <a href="http://twitter.com/share?text=<?php echo $tw_1; ?>" class="tw-a" target="_blank">

        <!-- Generator: Adobe Illustrator 18.1.1, SVG Export Plug-In . SVG Version: 6.00 Build 0)  -->
        <svg class="share-tw" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 612 612" style="enable-background:new 0 0 612 612;" xml:space="preserve">
        <g>
          <g>
            <path fill="#ffffff" d="M612,116.258c-22.525,9.981-46.694,16.75-72.088,19.772c25.929-15.527,45.777-40.155,55.184-69.411
      ...
      <a class="visit" href="<?php echo $site_url_1; ?>" target="_blank">Visit</a>
    </div>
    <div class="card-body">
      <h4 class="card-title"><?php echo $title_1; ?></h4>
    </div>
  </div>
    ...
    <div class="card sc-2 view overlay hm-stylish-strong" style="width: 20rem;" >
      ...
      <div class="mask">
        <p class="share">Share</p>
        <a href="https://www.facebook.com/sharer.php?u=<?php echo $fb_2; ?>" class="fb-a" target="_blank">
          <svg class="share-fb" id="Layer_1" style="enable-background:new 0 0 24 24;" version="1.1" viewBox="0 0 24 24" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><g><path  fill="#ffffff" d="M21.5,24.003h-5c-0.276,0-0.5-0.224-0.5-0.5v-9c0-0.276,0.224-0.5,0.5-0.5h2.64l0.667-2H16.5c-0.276,0-0.5-0.224-0.5-0.5   v-3c0-1.378,1.122-2.5,2.5-2.5H20v-2h-1.5c-2.481,0-4.5,2.019-4.5,4.5v3c0,0.276-0.224,0.5-0.5,0.5H11v2h2.5   c0.276,0,0.5,0.224,0.5,0.5v9c0,0.276-0.224,0.5-0.5,0.5h-11c-1.378,0-2.5-1.122-2.5-2.5v-19c0-1.378,1.122-2.5,2.5-2.5h19   c1.378,0,2.5,1.122,2.5,2.5v19C24,22.881,22.878,24.003,21.5,24.003z M17,23.003h4.5c0.827,0,1.5-0.673,1.5-1.5v-19   c0-0.827-0.673-1.5-1.5-1.5h-19c-0.827,0-1.5,0.673-1.5,1.5v19c0,0.827,0.673,1.5,1.5,1.5H13v-8h-2.5c-0.276,0-0.5-0.224-0.5-0.5   v-3c0-0.276,0.224-0.5,0.5-0.5H13v-2.5c0-3.033,2.467-5.5,5.5-5.5h2c0.276,0,0.5,0.224,0.5,0.5v3c0,0.276-0.224,0.5-0.5,0.5h-2   c-0.827,0-1.5,0.673-1.5,1.5v2.5h3.5c0.161,0,0.312,0.077,0.406,0.208c0.094,0.13,0.12,0.298,0.068,0.451l-1,3   c-0.068,0.204-0.259,0.342-0.474,0.342H17V23.003z"/></g><g/><g/><g/><g/><g/><g/><g/><g/><g/><g/><g/><g/><g/><g/><g/></svg></a>


        <a href="https://www.instagram.com/karialbrocoaching/" class="in-a" target="_blank"><svg class="share-in" aria-labelledby="simpleicons-instagram-icon" fill="#ffffff" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><title id="simpleicons-instagram-icon">Instagram icon</title><path d="M12 0C8.74 0 8.333.015 7.053.072 5.775.132 4.905.333 4.14.63c-.789.306-1.459.717-2.126 1.384S.935 3.35.63 4.14C.333 4.905.131 5.775.072 7.053.012 8.333 0 8.74 0 12s.015 3.667.072 4.947c.06 1.277.261 2.148.558 2.913.306.788.717 1.459 1.384 2.126.667.666 1.336 1.079 2.126 1.384.766.296 1.636.499 2.913.558C8.333 23.988 8.74 24 12 24s3.667-.015 4.947-.072c1.277-.06 2.148-.262 2.913-.558.788-.306 1.459-.718 2.126-1.384.666-.667 1.079-1.335 1.384-2.126.296-.765.499-1.636.558-2.913.06-1.28.072-1.687.072-4.947s-.015-3.667-.072-4.947c-.06-1.277-.262-2.149-.558-2.913-.306-.789-.718-1.459-1.384-2.126C21.319 1.347 20.651.935 19.86.63c-.765-.297-1.636-.499-2.913-.558C15.667.012 15.26 0 12 0zm0 2.16c3.203 0 3.585.016 4.85.071 1.17.055 1.805.249 2.227.415.562.217.96.477 1.382.896.419.42.679.819.896 1.381.164.422.36 1.057.413 2.227.057 1.266.07 1.646.07 4.85s-.015 3.585-.074 4.85c-.061 1.17-.256 1.805-.421 2.227-.224.562-.479.96-.899 1.382-.419.419-.824.679-1.38.896-.42.164-1.065.36-2.235.413-1.274.057-1.649.07-4.859.07-3.211 0-3.586-.015-4.859-.074-1.171-.061-1.816-.256-2.236-.421-.569-.224-.96-.479-1.379-.899-.421-.419-.69-.824-.9-1.38-.165-.42-.359-1.065-.42-2.235-.045-1.26-.061-1.649-.061-4.844 0-3.196.016-3.586.061-4.861.061-1.17.255-1.814.42-2.234.21-.57.479-.96.9-1.381.419-.419.81-.689 1.379-.898.42-.166 1.051-.361 2.221-.421 1.275-.045 1.65-.06 4.859-.06l.045.03zm0 3.678c-3.405 0-6.162 2.76-6.162 6.162 0 3.405 2.76 6.162 6.162 6.162 3.405 0 6.162-2.76 6.162-6.162 0-3.405-2.76-6.162-6.162-6.162zM12 16c-2.21 0-4-1.79-4-4s1.79-4 4-4 4 1.79 4 4-1.79 4-4 4zm7.846-10.405c0 .795-.646 1.44-1.44 1.44-.795 0-1.44-.646-1.44-1.44 0-.794.646-1.439 1.44-1.439.793-.001 1.44.645 1.44 1.439z"/></svg></a>

        <a href="http://twitter.com/share?text=<?php echo $tw_2; ?>" class="tw-a" target="_blank">
        ...
        <a class="visit" href="<?php echo $site_url_2; ?>" target="_blank">Visit</a>
      </div>
      <div class="card-body">
        <h4 class="card-title"><?php echo $title_2; ?></h4>
      </div>
    </div>
    ...
    <div class="card sc-3 view overlay hm-stylish-strong" style="width: 20rem;" >
      ...
      <div class="mask">
        <p class="share">Share</p>
        <a href="https://www.facebook.com/sharer.php?u=<?php echo $fb_3; ?>" class="fb-a" target="_blank">
          <svg class="share-fb" id="Layer_1" style="enable-background:new 0 0 24 24;" version="1.1" viewBox="0 0 24 24" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><g><path  fill="#ffffff" d="M21.5,24.003h-5c-0.276,0-0.5-0.224-0.5-0.5v-9c0-0.276,0.224-0.5,0.5-0.5h2.64l0.667-2H16.5c-0.276,0-0.5-0.224-0.5-0.5   v-3c0-1.378,1.122-2.5,2.5-2.5H20v-2h-1.5c-2.481,0-4.5,2.019-4.5,4.5v3c0,0.276-0.224,0.5-0.5,0.5H11v2h2.5   c0.276,0,0.5,0.224,0.5,0.5v9c0,0.276-0.224,0.5-0.5,0.5h-11c-1.378,0-2.5-1.122-2.5-2.5v-19c0-1.378,1.122-2.5,2.5-2.5h19   c1.378,0,2.5,1.122,2.5,2.5v19C24,22.881,22.878,24.003,21.5,24.003z M17,23.003h4.5c0.827,0,1.5-0.673,1.5-1.5v-19   c0-0.827-0.673-1.5-1.5-1.5h-19c-0.827,0-1.5,0.673-1.5,1.5v19c0,0.827,0.673,1.5,1.5,1.5H13v-8h-2.5c-0.276,0-0.5-0.224-0.5-0.5   v-3c0-0.276,0.224-0.5,0.5-0.5H13v-2.5c0-3.033,2.467-5.5,5.5-5.5h2c0.276,0,0.5,0.224,0.5,0.5v3c0,0.276-0.224,0.5-0.5,0.5h-2   c-0.827,0-1.5,0.673-1.5,1.5v2.5h3.5c0.161,0,0.312,0.077,0.406,0.208c0.094,0.13,0.12,0.298,0.068,0.451l-1,3   c-0.068,0.204-0.259,0.342-0.474,0.342H17V23.003z"/></g><g/><g/><g/><g/><g/><g/><g/><g/><g/><g/><g/><g/><g/><g/><g/></svg></a>


        <a href="https://www.instagram.com/karialbrocoaching/" class="in-a" target="_blank"><svg class="share-in" aria-labelledby="simpleicons-instagram-icon" fill="#ffffff" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><title id="simpleicons-instagram-icon">Instagram icon</title><path d="M12 0C8.74 0 8.333.015 7.053.072 5.775.132 4.905.333 4.14.63c-.789.306-1.459.717-2.126 1.384S.935 3.35.63 4.14C.333 4.905.131 5.775.072 7.053.012 8.333 0 8.74 0 12s.015 3.667.072 4.947c.06 1.277.261 2.148.558 2.913.306.788.717 1.459 1.384 2.126.667.666 1.336 1.079 2.126 1.384.766.296 1.636.499 2.913.558C8.333 23.988 8.74 24 12 24s3.667-.015 4.947-.072c1.277-.06 2.148-.262 2.913-.558.788-.306 1.459-.718 2.126-1.384.666-.667 1.079-1.335 1.384-2.126.296-.765.499-1.636.558-2.913.06-1.28.072-1.687.072-4.947s-.015-3.667-.072-4.947c-.06-1.277-.262-2.149-.558-2.913-.306-.789-.718-1.459-1.384-2.126C21.319 1.347 20.651.935 19.86.63c-.765-.297-1.636-.499-2.913-.558C15.667.012 15.26 0 12 0zm0 2.16c3.203 0 3.585.016 4.85.071 1.17.055 1.805.249 2.227.415.562.217.96.477 1.382.896.419.42.679.819.896 1.381.164.422.36 1.057.413 2.227.057 1.266.07 1.646.07 4.85s-.015 3.585-.074 4.85c-.061 1.17-.256 1.805-.421 2.227-.224.562-.479.96-.899 1.382-.419.419-.824.679-1.38.896-.42.164-1.065.36-2.235.413-1.274.057-1.649.07-4.859.07-3.211 0-3.586-.015-4.859-.074-1.171-.061-1.816-.256-2.236-.421-.569-.224-.96-.479-1.379-.899-.421-.419-.69-.824-.9-1.38-.165-.42-.359-1.065-.42-2.235-.045-1.26-.061-1.649-.061-4.844 0-3.196.016-3.586.061-4.861.061-1.17.255-1.814.42-2.234.21-.57.479-.96.9-1.381.419-.419.81-.689 1.379-.898.42-.166 1.051-.361 2.221-.421 1.275-.045 1.65-.06 4.859-.06l.045.03zm0 3.678c-3.405 0-6.162 2.76-6.162 6.162 0 3.405 2.76 6.162 6.162 6.162 3.405 0 6.162-2.76 6.162-6.162 0-3.405-2.76-6.162-6.162-6.162zM12 16c-2.21 0-4-1.79-4-4s1.79-4 4-4 4 1.79 4 4-1.79 4-4 4zm7.846-10.405c0 .795-.646 1.44-1.44 1.44-.795 0-1.44-.646-1.44-1.44 0-.794.646-1.439 1.44-1.439.793-.001 1.44.645 1.44 1.439z"/></svg></a>

        <a href="http://twitter.com/share?text=<?php echo $tw_3; ?>" class="tw-a" target="_blank">
        ...
        <a class="visit" href="<?php echo $site_url_3; ?>" target="_blank">Visit</a>
      </div>
      <div class="card-body">
        <h4 class="card-title"><?php echo $title_3; ?></h4>
      </div>
    </div>
  ...
  <div class="card sc-4 view overlay hm-stylish-strong" style="width: 20rem;" >
    ...
    <div class="mask">
      <p class="share">Share</p>
      <a href="https://www.facebook.com/sharer.php?u=<?php echo $fb_4; ?>" class="fb-a" target="_blank">
        <svg class="share-fb" id="Layer_1" style="enable-background:new 0 0 24 24;" version="1.1" viewBox="0 0 24 24" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><g><path  fill="#ffffff" d="M21.5,24.003h-5c-0.276,0-0.5-0.224-0.5-0.5v-9c0-0.276,0.224-0.5,0.5-0.5h2.64l0.667-2H16.5c-0.276,0-0.5-0.224-0.5-0.5   v-3c0-1.378,1.122-2.5,2.5-2.5H20v-2h-1.5c-2.481,0-4.5,2.019-4.5,4.5v3c0,0.276-0.224,0.5-0.5,0.5H11v2h2.5   c0.276,0,0.5,0.224,0.5,0.5v9c0,0.276-0.224,0.5-0.5,0.5h-11c-1.378,0-2.5-1.122-2.5-2.5v-19c0-1.378,1.122-2.5,2.5-2.5h19   c1.378,0,2.5,1.122,2.5,2.5v19C24,22.881,22.878,24.003,21.5,24.003z M17,23.003h4.5c0.827,0,1.5-0.673,1.5-1.5v-19   c0-0.827-0.673-1.5-1.5-1.5h-19c-0.827,0-1.5,0.673-1.5,1.5v19c0,0.827,0.673,1.5,1.5,1.5H13v-8h-2.5c-0.276,0-0.5-0.224-0.5-0.5   v-3c0-0.276,0.224-0.5,0.5-0.5H13v-2.5c0-3.033,2.467-5.5,5.5-5.5h2c0.276,0,0.5,0.224,0.5,0.5v3c0,0.276-0.224,0.5-0.5,0.5h-2   c-0.827,0-1.5,0.673-1.5,1.5v2.5h3.5c0.161,0,0.312,0.077,0.406,0.208c0.094,0.13,0.12,0.298,0.068,0.451l-1,3   c-0.068,0.204-0.259,0.342-0.474,0.342H17V23.003z"/></g><g/><g/><g/><g/><g/><g/><g/><g/><g/><g/><g/><g/><g/><g/><g/></svg></a>


      <a href="https://www.instagram.com/karialbrocoaching/" class="in-a" target="_blank"><svg class="share-in" aria-labelledby="simpleicons-instagram-icon" fill="#ffffff" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><title id="simpleicons-instagram-icon">Instagram icon</title><path d="M12 0C8.74 0 8.333.015 7.053.072 5.775.132 4.905.333 4.14.63c-.789.306-1.459.717-2.126 1.384S.935 3.35.63 4.14C.333 4.905.131 5.775.072 7.053.012 8.333 0 8.74 0 12s.015 3.667.072 4.947c.06 1.277.261 2.148.558 2.913.306.788.717 1.459 1.384 2.126.667.666 1.336 1.079 2.126 1.384.766.296 1.636.499 2.913.558C8.333 23.988 8.74 24 12 24s3.667-.015 4.947-.072c1.277-.06 2.148-.262 2.913-.558.788-.306 1.459-.718 2.126-1.384.666-.667 1.079-1.335 1.384-2.126.296-.765.499-1.636.558-2.913.06-1.28.072-1.687.072-4.947s-.015-3.667-.072-4.947c-.06-1.277-.262-2.149-.558-2.913-.306-.789-.718-1.459-1.384-2.126C21.319 1.347 20.651.935 19.86.63c-.765-.297-1.636-.499-2.913-.558C15.667.012 15.26 0 12 0zm0 2.16c3.203 0 3.585.016 4.85.071 1.17.055 1.805.249 2.227.415.562.217.96.477 1.382.896.419.42.679.819.896 1.381.164.422.36 1.057.413 2.227.057 1.266.07 1.646.07 4.85s-.015 3.585-.074 4.85c-.061 1.17-.256 1.805-.421 2.227-.224.562-.479.96-.899 1.382-.419.419-.824.679-1.38.896-.42.164-1.065.36-2.235.413-1.274.057-1.649.07-4.859.07-3.211 0-3.586-.015-4.859-.074-1.171-.061-1.816-.256-2.236-.421-.569-.224-.96-.479-1.379-.899-.421-.419-.69-.824-.9-1.38-.165-.42-.359-1.065-.42-2.235-.045-1.26-.061-1.649-.061-4.844 0-3.196.016-3.586.061-4.861.061-1.17.255-1.814.42-2.234.21-.57.479-.96.9-1.381.419-.419.81-.689 1.379-.898.42-.166 1.051-.361 2.221-.421 1.275-.045 1.65-.06 4.859-.06l.045.03zm0 3.678c-3.405 0-6.162 2.76-6.162 6.162 0 3.405 2.76 6.162 6.162 6.162 3.405 0 6.162-2.76 6.162-6.162 0-3.405-2.76-6.162-6.162-6.162zM12 16c-2.21 0-4-1.79-4-4s1.79-4 4-4 4 1.79 4 4-1.79 4-4 4zm7.846-10.405c0 .795-.646 1.44-1.44 1.44-.795 0-1.44-.646-1.44-1.44 0-.794.646-1.439 1.44-1.439.793-.001 1.44.645 1.44 1.439z"/></svg></a>

      <a href="http://twitter.com/share?text=<?php echo $tw_4; ?>" class="tw-a" target="_blank">
      ...
      <a class="visit" href="<?php echo $site_url_4; ?>" target="_blank">Visit</a>
    </div>
    <div class="card-body">
      <h4 class="card-title"><?php echo $title_4; ?></h4>
    </div>
  </div>
  ...
  <div class="card sc-5 view overlay hm-stylish-strong" style="width: 20rem;" >
    ...
    <div class="mask">
      <p class="share">Share</p>
      <a href="https://www.facebook.com/sharer.php?u=<?php echo $fb_5; ?>" class="fb-a" target="_blank">
        <svg class="share-fb" id="Layer_1" style="enable-background:new 0 0 24 24;" version="1.1" viewBox="0 0 24 24" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><g><path  fill="#ffffff" d="M21.5,24.003h-5c-0.276,0-0.5-0.224-0.5-0.5v-9c0-0.276,0.224-0.5,0.5-0.5h2.64l0.667-2H16.5c-0.276,0-0.5-0.224-0.5-0.5   v-3c0-1.378,1.122-2.5,2.5-2.5H20v-2h-1.5c-2.481,0-4.5,2.019-4.5,4.5v3c0,0.276-0.224,0.5-0.5,0.5H11v2h2.5   c0.276,0,0.5,0.224,0.5,0.5v9c0,0.276-0.224,0.5-0.5,0.5h-11c-1.378,0-2.5-1.122-2.5-2.5v-19c0-1.378,1.122-2.5,2.5-2.5h19   c1.378,0,2.5,1.122,2.5,2.5v19C24,22.881,22.878,24.003,21.5,24.003z M17,23.003h4.5c0.827,0,1.5-0.673,1.5-1.5v-19   c0-0.827-0.673-1.5-1.5-1.5h-19c-0.827,0-1.5,0.673-1.5,1.5v19c0,0.827,0.673,1.5,1.5,1.5H13v-8h-2.5c-0.276,0-0.5-0.224-0.5-0.5   v-3c0-0.276,0.224-0.5,0.5-0.5H13v-2.5c0-3.033,2.467-5.5,5.5-5.5h2c0.276,0,0.5,0.224,0.5,0.5v3c0,0.276-0.224,0.5-0.5,0.5h-2   c-0.827,0-1.5,0.673-1.5,1.5v2.5h3.5c0.161,0,0.312,0.077,0.406,0.208c0.094,0.13,0.12,0.298,0.068,0.451l-1,3   c-0.068,0.204-0.259,0.342-0.474,0.342H17V23.003z"/></g><g/><g/><g/><g/><g/><g/><g/><g/><g/><g/><g/><g/><g/><g/><g/></svg></a>


      <a href="https://www.instagram.com/karialbrocoaching/" class="in-a" target="_blank"><svg class="share-in" aria-labelledby="simpleicons-instagram-icon" fill="#ffffff" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><title id="simpleicons-instagram-icon">Instagram icon</title><path d="M12 0C8.74 0 8.333.015 7.053.072 5.775.132 4.905.333 4.14.63c-.789.306-1.459.717-2.126 1.384S.935 3.35.63 4.14C.333 4.905.131 5.775.072 7.053.012 8.333 0 8.74 0 12s.015 3.667.072 4.947c.06 1.277.261 2.148.558 2.913.306.788.717 1.459 1.384 2.126.667.666 1.336 1.079 2.126 1.384.766.296 1.636.499 2.913.558C8.333 23.988 8.74 24 12 24s3.667-.015 4.947-.072c1.277-.06 2.148-.262 2.913-.558.788-.306 1.459-.718 2.126-1.384.666-.667 1.079-1.335 1.384-2.126.296-.765.499-1.636.558-2.913.06-1.28.072-1.687.072-4.947s-.015-3.667-.072-4.947c-.06-1.277-.262-2.149-.558-2.913-.306-.789-.718-1.459-1.384-2.126C21.319 1.347 20.651.935 19.86.63c-.765-.297-1.636-.499-2.913-.558C15.667.012 15.26 0 12 0zm0 2.16c3.203 0 3.585.016 4.85.071 1.17.055 1.805.249 2.227.415.562.217.96.477 1.382.896.419.42.679.819.896 1.381.164.422.36 1.057.413 2.227.057 1.266.07 1.646.07 4.85s-.015 3.585-.074 4.85c-.061 1.17-.256 1.805-.421 2.227-.224.562-.479.96-.899 1.382-.419.419-.824.679-1.38.896-.42.164-1.065.36-2.235.413-1.274.057-1.649.07-4.859.07-3.211 0-3.586-.015-4.859-.074-1.171-.061-1.816-.256-2.236-.421-.569-.224-.96-.479-1.379-.899-.421-.419-.69-.824-.9-1.38-.165-.42-.359-1.065-.42-2.235-.045-1.26-.061-1.649-.061-4.844 0-3.196.016-3.586.061-4.861.061-1.17.255-1.814.42-2.234.21-.57.479-.96.9-1.381.419-.419.81-.689 1.379-.898.42-.166 1.051-.361 2.221-.421 1.275-.045 1.65-.06 4.859-.06l.045.03zm0 3.678c-3.405 0-6.162 2.76-6.162 6.162 0 3.405 2.76 6.162 6.162 6.162 3.405 0 6.162-2.76 6.162-6.162 0-3.405-2.76-6.162-6.162-6.162zM12 16c-2.21 0-4-1.79-4-4s1.79-4 4-4 4 1.79 4 4-1.79 4-4 4zm7.846-10.405c0 .795-.646 1.44-1.44 1.44-.795 0-1.44-.646-1.44-1.44 0-.794.646-1.439 1.44-1.439.793-.001 1.44.645 1.44 1.439z"/></svg></a>

      <a href="http://twitter.com/share?text=<?php echo $tw_5; ?>" class="tw-a" target="_blank">
      ...
      <a class="visit" href="<?php echo $site_url_5; ?>" target="_blank">Visit</a>
    </div>
    <div class="card-body">
      <h4 class="card-title"><?php echo $title_5; ?></h4>
    </div>
  </div>
  ...
  <div class="card sc-6 view overlay hm-stylish-strong" style="width: 20rem;" >
    ...
    <div class="mask">
      <p class="share">Share</p>
      <a href="https://www.facebook.com/sharer.php?u=<?php echo $fb_6; ?>" class="fb-a" target="_blank">
        <svg class="share-fb" id="Layer_1" style="enable-background:new 0 0 24 24;" version="1.1" viewBox="0 0 24 24" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><g><path  fill="#ffffff" d="M21.5,24.003h-5c-0.276,0-0.5-0.224-0.5-0.5v-9c0-0.276,0.224-0.5,0.5-0.5h2.64l0.667-2H16.5c-0.276,0-0.5-0.224-0.5-0.5   v-3c0-1.378,1.122-2.5,2.5-2.5H20v-2h-1.5c-2.481,0-4.5,2.019-4.5,4.5v3c0,0.276-0.224,0.5-0.5,0.5H11v2h2.5   c0.276,0,0.5,0.224,0.5,0.5v9c0,0.276-0.224,0.5-0.5,0.5h-11c-1.378,0-2.5-1.122-2.5-2.5v-19c0-1.378,1.122-2.5,2.5-2.5h19   c1.378,0,2.5,1.122,2.5,2.5v19C24,22.881,22.878,24.003,21.5,24.003z M17,23.003h4.5c0.827,0,1.5-0.673,1.5-1.5v-19   c0-0.827-0.673-1.5-1.5-1.5h-19c-0.827,0-1.5,0.673-1.5,1.5v19c0,0.827,0.673,1.5,1.5,1.5H13v-8h-2.5c-0.276,0-0.5-0.224-0.5-0.5   v-3c0-0.276,0.224-0.5,0.5-0.5H13v-2.5c0-3.033,2.467-5.5,5.5-5.5h2c0.276,0,0.5,0.224,0.5,0.5v3c0,0.276-0.224,0.5-0.5,0.5h-2   c-0.827,0-1.5,0.673-1.5,1.5v2.5h3.5c0.161,0,0.312,0.077,0.406,0.208c0.094,0.13,0.12,0.298,0.068,0.451l-1,3   c-0.068,0.204-0.259,0.342-0.474,0.342H17V23.003z"/></g><g/><g/><g/><g/><g/><g/><g/><g/><g/><g/><g/><g/><g/><g/><g/></svg></a>


      <a href="https://www.instagram.com/karialbrocoaching/" class="in-a" target="_blank"><svg class="share-in" aria-labelledby="simpleicons-instagram-icon" fill="#ffffff" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><title id="simpleicons-instagram-icon">Instagram icon</title><path d="M12 0C8.74 0 8.333.015 7.053.072 5.775.132 4.905.333 4.14.63c-.789.306-1.459.717-2.126 1.384S.935 3.35.63 4.14C.333 4.905.131 5.775.072 7.053.012 8.333 0 8.74 0 12s.015 3.667.072 4.947c.06 1.277.261 2.148.558 2.913.306.788.717 1.459 1.384 2.126.667.666 1.336 1.079 2.126 1.384.766.296 1.636.499 2.913.558C8.333 23.988 8.74 24 12 24s3.667-.015 4.947-.072c1.277-.06 2.148-.262 2.913-.558.788-.306 1.459-.718 2.126-1.384.666-.667 1.079-1.335 1.384-2.126.296-.765.499-1.636.558-2.913.06-1.28.072-1.687.072-4.947s-.015-3.667-.072-4.947c-.06-1.277-.262-2.149-.558-2.913-.306-.789-.718-1.459-1.384-2.126C21.319 1.347 20.651.935 19.86.63c-.765-.297-1.636-.499-2.913-.558C15.667.012 15.26 0 12 0zm0 2.16c3.203 0 3.585.016 4.85.071 1.17.055 1.805.249 2.227.415.562.217.96.477 1.382.896.419.42.679.819.896 1.381.164.422.36 1.057.413 2.227.057 1.266.07 1.646.07 4.85s-.015 3.585-.074 4.85c-.061 1.17-.256 1.805-.421 2.227-.224.562-.479.96-.899 1.382-.419.419-.824.679-1.38.896-.42.164-1.065.36-2.235.413-1.274.057-1.649.07-4.859.07-3.211 0-3.586-.015-4.859-.074-1.171-.061-1.816-.256-2.236-.421-.569-.224-.96-.479-1.379-.899-.421-.419-.69-.824-.9-1.38-.165-.42-.359-1.065-.42-2.235-.045-1.26-.061-1.649-.061-4.844 0-3.196.016-3.586.061-4.861.061-1.17.255-1.814.42-2.234.21-.57.479-.96.9-1.381.419-.419.81-.689 1.379-.898.42-.166 1.051-.361 2.221-.421 1.275-.045 1.65-.06 4.859-.06l.045.03zm0 3.678c-3.405 0-6.162 2.76-6.162 6.162 0 3.405 2.76 6.162 6.162 6.162 3.405 0 6.162-2.76 6.162-6.162 0-3.405-2.76-6.162-6.162-6.162zM12 16c-2.21 0-4-1.79-4-4s1.79-4 4-4 4 1.79 4 4-1.79 4-4 4zm7.846-10.405c0 .795-.646 1.44-1.44 1.44-.795 0-1.44-.646-1.44-1.44 0-.794.646-1.439 1.44-1.439.793-.001 1.44.645 1.44 1.439z"/></svg></a>

      <a href="http://twitter.com/share?text=<?php echo $tw_6; ?>" class="tw-a" target="_blank">
      ...
      <a class="visit" href="<?php echo $site_url_6; ?>" target="_blank">Visit</a>
    </div>
    <div class="card-body">
      <h4 class="card-title"><?php echo $title_6; ?></h4>
    </div>
  </div>
...
<script type="text/javascript">require(["mojo/signup-forms/Loader"], function(L) { L.start({"baseUrl":"mc.us14.list-manage.com","uuid":"70dabbb8406ea084974221b68","lid":"85f4799f29"}) })</script> -->
